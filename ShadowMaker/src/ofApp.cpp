...
//    spotlight.enable();
    ...
    spotlight.setAmbientColor(ofFloatColor(0.5,0.2,0.2,1.0));
    spotlight.setDiffuseColor(ofFloatColor(0.5,0.5,1.0));
    spotlight.setSpecularColor(ofFloatColor(0.5,0.5,0.5));
